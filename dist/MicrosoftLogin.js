...
var getUserAgentApp = function (clientId, tenantUrl, redirectUri) {
...
var MicrosoftLogin = (function (_super) {
    ...
    function MicrosoftLogin(props) {
        ...
        _this.login = function () {
            ...
            var _b = _this.props, _c = _b.withUserData, withUserData = _c === void 0 ? false : _c, authCallback = _b.authCallback, _d = _b.forceRedirectStrategy, forceRedirectStrategy = _d === void 0 ? false : _d, _e = _b.prompt, prompt = _e === void 0 ? undefined : _e;
            if (msalInstance) {
                _this.log("Login STARTED");
                if (forceRedirectStrategy || _this.checkToIE()) {
                    _this.redirectLogin(msalInstance, scopes, prompt);
                }
                else {
                    _this.popupLogin(msalInstance, scopes, prompt, withUserData, authCallback);
                }
            }
            else {
        ...
        var graphScopes = props.graphScopes, clientId = props.clientId, tenantUrl = props.tenantUrl, redirectUri = props.redirectUri, prompt = props.prompt;
        _this.state = {
        ...
        if (!msalInstance) {
            ...
            msalInstance.handleRedirectCallback(function (error, authResponse) {
                if (!error && authResponse) {
                    ...
                    _this.getGraphAPITokenAndUser(msalInstance, scopes, withUserData, authCallback, true);
                }
                else {
    ...
    MicrosoftLogin.prototype.getGraphAPITokenAndUser = function (msalInstance, scopes, withUserData, authCallback, isRedirect) {
        var _this = this;
        return msalInstance
    ...
    MicrosoftLogin.prototype.popupLogin = function (msalInstance, scopes, prompt, withUserData, authCallback) {
        var _this = this;
        ...
        msalInstance
            ...
            _this.log("Fetch Graph API 'access_token' in silent mode STARTED");
            _this.getGraphAPITokenAndUser(msalInstance, scopes, withUserData, authCallback, false);
        })
            .catch(function (error) {
    ...
    MicrosoftLogin.prototype.redirectLogin = function (msalInstance, scopes, prompt) {
